    ...
    <div class="col-md-8 offset-md-2 my-5">
        ...
        <ul class="jobsList">
            ...
            <div class="col-6 mx-auto justify-content-md-end">
                <form method="POST">
                    <button class="btn btn-lg btn-success" type="submit" style="width: 100%; margin-bottom: 30px;" name="approve-interview">Одобри за интервю</button>
                    <button class="btn btn-lg btn-success" type="submit" style="width: 100%; margin-bottom: 30px;" name="interviewed">Интервюиран</button>
                    <button class="btn btn-lg btn-success" type="submit" style="width: 100%; margin-bottom: 30px;" name="approved">Одобрен</button>
                    <button class="btn btn-lg btn-danger" type="submit" style="width: 100%;" name="reject">Отхвърли</button>
                </form>
            </div>
        </ul>
    </div>
